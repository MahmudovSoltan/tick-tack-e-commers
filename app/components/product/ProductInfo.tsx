...
const ProductInfo = ({ product, addbasket, deletebasket, isBasketProduct,addFavoritesFUnc }) => {
    ...
    return (
        <div className="product_info_container">
            <div className="favorites_icon">
                {
                    product?.is_favorite ? <FaHeart onClick={()=>addFavoritesFUnc(product.id)} size={36} color="red" /> :
                        <svg onClick={()=>addFavoritesFUnc(product.id)} width="36" height="36" viewBox="0 0 36 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="product_body_content">
...

                    {
                        isBasketProduct ? <div className="peroduct_btns">
                            <button onClick={() => deletebasket(product.id)}>
                        ...
                        </div> : <button onClick={() => addbasket(product.id)} className="basket_btn">
                            Səbətə əlavə et
                        </button>
                    }
