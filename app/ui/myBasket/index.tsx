    ...
    return (
        <div className="my_basket_container">
                        ...
                        <div className="basket_image">
                            {
                                item.product.img_url ?
                                    <Image className="rounded-[8px] " src={item.product.img_url} alt="basket-image" width={55} height={33} objectFit="cover" />
                        ...
                        <div className="basket_top_left">
                            ...
                            <div className="basket_top_quantity">
                                <div className="basket_buttons">
                                    <button onClick={() => deleteProduct(item.product.id)} className="decriment_btn">
                                    ...
                                    <button className="incriment_btn">
                                        <svg onClick={() => addbasket(item.product.id)} width="10" height="10" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="basket_bottom">
                ...
                <button className="basket_confirm_btn" onClick={() => navigate.push("/checkout")}>
                    Sifarişi tamamla
                </button>
            </div>
        </div>
